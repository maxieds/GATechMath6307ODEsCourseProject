...
\item Moreover, standard ODE methods for solving an IVP of the form $\dot{x} = Ax, x(0)=(x_0, y_0)$ for a $2 \times 2$ 
      ...
      x_a(t) \\ y_a(t) 
      \end{bmatrix} = 
      %\exp\left(\begin{bmatrix} 0 & -1 \\ 1 & a \end{bmatrix}\right) \begin{bmatrix} 1 \\ 1 \end{bmatrix} = 
      \begin{bmatrix}
...
\end{code}
     (TODO)
%\includegraphics[height=0.85\textheight]{../Images/RosslerAttractorExpt2-2021-10-28-031737.png}
\end{center}
